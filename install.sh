...
# A common function. Regardless of the distro being used
  ...
  echo "Install tmux, alacritty, and zsh"
...
archinstall(){
  ...
  sudo pacman -Syyu xorg-xrandr xorg-xsetroot nvidia parcellite rust xfce4-power-manager cargo-bloat evince \
ttf-font-awesome pipewire awesome feh xorg xorg-xinit xorg-server steam wine nvidia nvidia-prime \
nvidia-utils nvidia-settings mesa-demos wget udisks2 gvfs gvfs-mtp nautilus kitty bashtop firefox xterm gvim unzip file-roller \

...
if awesome.startup_errors then
    naughty.notify({ preset = naughty.config.presets.critical,
                     title = "Hey fuckface! Try to do something right once in your life.",
...
--  Shortcuts start here  
     ...
     -- PrintScreen
	awful.key({ }, "Print", function () awful.util.spawn("xfce4-screenshooter -f", false) end,
     {description = "Screenshot", group = "Custom"}),



     --Sectional screenshot
	awful.key({ "Shift" }, "Print", function () awful.util.spawn("xfce4-screenshooter -r", false) end,
     {description = "Sectional screenshot", group = "Custom"}),
